...
//  Project8
//
//  Created by Ray Varkki on 2025-09-04.
//
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        //Placing score label to the top right of the screen
    ...
    @objc func submitTapped(_ sender: UIButton){
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText){
            ...
            let ac = UIAlertController(title: "That was an incorrect guess", message: nil, preferredStyle: .alert)
        ...
        DispatchQueue.global(qos: .userInitiated).async{
            ...
            if let levelFileUrl = Bundle.main.url(forResource: "level\(self?.level ?? 1)", withExtension: "txt"){
                if let levelContent = try? String(contentsOf: levelFileUrl, encoding: .utf8){
                    var lines = levelContent.description.components(separatedBy: "\n")
                    lines.shuffle()
